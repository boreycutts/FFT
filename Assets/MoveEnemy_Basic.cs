...
public class MoveEnemy_Basic : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        is_alive1 = true; // ADD FUNCTIONALITY TO ENNEMY CONTROLLER
    }
    ...
    void Update()
    {
        if (is_alive1)
        {
            ...
            target_position.x = MovePlayer.player_position.x + 6;
            target_position.y = MovePlayer.player_position.y - 5;
            transform.localPosition = Vector3.Lerp(transform.localPosition, target_position, Time.deltaTime * 5);
